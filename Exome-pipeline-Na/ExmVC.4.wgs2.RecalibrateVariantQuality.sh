...
while getopts i:r:l:t:PXBH opt; do
    case "$opt" in
        i) InpFil="$OPTARG";;
        r) RefFil="$OPTARG";; 
		t) BedFil="$OPTARG";;
...
#WGS: http://gatkforums.broadinstitute.org/gatk/discussion/3952/variantrecalibrator-no-data-found
InfoFields="-an QD -an ReadPosRankSum -an FS -an SOR -an MQ" 
