...
#some variables
EXOMFILT=/home/local/ARCS/hq2130/Exome_Seq/Filtering_scripts  #/home/local/ARCS/nz2274/Pipeline/Filtering_scripts
HapMapReference=/home/local/ARCS/nz2274/Resources/1000Gneome_2013/plink/1KG.XGEN.SNP   #/home/local/ARCS/hq2130/Exome_Seq/resources/hapmap31_pop/hg19/All_HapMap
...
#    if [[ $SamLen -lt 500 ]]; then
        vcftools --gzvcf $VcfFil --plink-tped --out $BbfNam.tmp
        plink --tfile $BbfNam.tmp --out $BbfNam
        #plink --bfile $BbfNam.tmp --make-bed --out $BbfNam
        rm -f $BbfNam.tmp*
 #   else
  #      mkdir -p TempSplit
...
awk '{if($6==-9){$6=1}print }' $EigDat.fam >$EigDat.pedind
